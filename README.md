...
**54 papers · 2017–2026.** [2026](#2026) · [2025](#2025) · [2024](#2024) · [2023](#2023) · [2022](#2022) · [2021](#2021) · [2020](#2020) · [2019](#2019) · [2018](#2018) · [2017](#2017)
...
- **Guided diffusion-based image editing for landslide image synthesis in remote sensing change detection** — **[ISPRS JPRS 2026](https://doi.org/10.1016/j.isprsjprs.2026.08.007)** [[Code and Data](https://github.com/yixin28/HHDL-Dataset)]
  - Method: **Guided Landslide Generator (GLG)**. Uses landslide-specific prompts, spatio-temporal metadata, and DEM-informed masks to edit non-landslide samples into realistic landslide-change samples for change detection. Evaluated on **GVLM** and the newly constructed **HHDL** dataset.

- **Enhancing Sentinel-2 landslide change detection by integrating multispectral, deformation, and topographic information** — **[IJAEOG 2026](https://doi.org/10.1016/j.jag.2026.105116)** [[Code and Data](https://github.com/Trifurs/DMLCDNet)]
  - Method: **DMLCDNet**. Fuses bi-temporal Sentinel-2 multispectral features with Sentinel-1 deformation and ALOS DEM topographic information for landslide change detection, evaluated across Jiuzhaigou, Luding, Longyan, and additional generalization cases.
...
| Landslide mapping and change detection | [Landslide4Sense](https://doi.org/10.1109/TGRS.2022.3215209), [Landslide4Sense competition report](https://doi.org/10.1109/JSTARS.2022.3220845), [GVLM](https://doi.org/10.1016/j.isprsjprs.2023.01.018), [HR-GLDD](https://essd.copernicus.org/articles/15/3283/2023/), [GDCLD](https://essd.copernicus.org/articles/16/4817/2024/), [HHDL](https://github.com/yixin28/HHDL-Dataset), [DMLCDNet](https://github.com/Trifurs/DMLCDNet) | Multisource or very-high-resolution imagery → landslide masks, synthetic landslide changes and cross-region evaluation |
...
| --- | --- | --- |
| Segmentation and change detection | [GVLM cross-domain mapping](https://doi.org/10.1016/j.isprsjprs.2023.01.018), [Guided Landslide Generator (GLG)](https://doi.org/10.1016/j.isprsjprs.2026.08.007), [DMLCDNet](https://doi.org/10.1016/j.jag.2026.105116), [Change3D](https://openaccess.thecvf.com/content/CVPR2025/papers/Zhu_Change3D_Revisiting_Change_Detection_and_Captioning_from_A_Video_Modeling_CVPR_2025_paper.pdf), [BAM-CD/FLOGA](https://doi.org/10.1109/JSTARS.2024.3381737), domain-incremental fire detection ([JAG 2023](https://www.sciencedirect.com/science/article/pii/S1569843223001012)) | Pixel segmentation, bi-temporal change, synthetic landslide generation, building damage and domain generalization |
